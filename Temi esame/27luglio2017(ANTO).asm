...
ISR_PA_IN   PROC 
               ; vedo se sto inviando dati
               cmp flag , 1
               je invia_zero               
              ;devo immagazzinare i dati finche non ne arriva uno negativo
              ...
              inc si
              jmp fine
negativo:   ;comincio ad inviare (avvio output), il primo e' il counter
            mov flag , 1
            mov al,cl 
            out 81h ,al
            jmp fine
...
ISR_PB_OUT  PROC  
              ;mando vettore e poi 00 , l'interrupt deve essere di nuovo abilitato 
              sti
              cmp flag_again,0
              jne sec_time
              cmp si,0
